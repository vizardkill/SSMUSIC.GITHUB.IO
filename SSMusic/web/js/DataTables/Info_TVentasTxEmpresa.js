...
$(document).ready(function () {
       $('#table_VentasTxEmpresa').dataTable().fnDestroy();
    var table = $('#table_VentasTxEmpresa').DataTable({
        language: {
        ...
        ajax: {
            method: "GET",
            url: "../../Datos?peticion=data_Informe&tipo=TVentasxEmpresa",
            dataSrc: "TVentasxEmpresa"
        },
        select: "single",
        columns: [
            {
    ...
    $('#table_VentasTxEmpresa tbody').on('click', 'td.details-control', function () {
...
// Open this row
            row.child(table_VentasTxEmpresaFormat(row.data())).show();
            tr.addClass('shown');
...
function table_VentasTxEmpresaFormat(d) {
